...
const Home = () => {
            ...
            expenses: [
                {
                    ...
                    location: "ByProgrammer's tution center",
                    total: 100.00,
                ...
                },
                {
                    ...
                    location: "ByProgrammer's Book Store",
                    total: 20.00,
            ...
            expenses: [
                {
                    ...
                    title: "Vitamins",
                    description: "Vitamin",
                    location: "ByProgrammer's Pharmacy",
                    total: 25.00,
                    status: pendingStatus,
                },
                {
            ...
            expenses: [
                {
                    ...
                    title: "Toys",
                    description: "toys",
                    location: "ByProgrammer's Toy Store",
                    total: 25.00,
                    status: confirmStatus,
                },
                {
                    ...
                    location: "ByProgrammer's Baby Care Store",
                    total: 100.00,
                    status: pendingStatus,
                },
                {
                    ...
                    title: "Pampers",
                    description: "Pampers",
                    location: "ByProgrammer's Supermarket",
                    total: 100.00,
                    status: pendingStatus,
                },
                {
                    ...
                    title: "Baby T-Shirt",
                    description: "T-Shirt",
                    location: "ByProgrammer's Fashion Store",
                    total: 20.00,
                    status: pendingStatus,
                }
            ]
    ...
    function renderHeader() {
        return (
            <View style={{
                paddingHorizontal: SIZES.padding, paddingHorizontal: SIZES.padding,
                backgroundColor: COLORS.white }}>
                <View>
                ...
                <View style={{ paddingHorizontal: SIZES.padding }}>
                    ...
                    <View style={{ flexDirection: 'row'}}>
                        ...
                        <Text style={{
                            ...
                            ...FONTS.body4}}>{item.location}</Text>
                    </View>
                </View>
                {/* Price */}
                <View
        ...
        return (
            <View style={{ alignItems: 'center', justifyContent: 'center'}}>
                <VictoryPie
                    ...
                    radius={({ datum }) => (selectedCategory && selectedCategory.name
            ...
            return (
                <TouchableOpacity
                    style={{
                        ...
                        borderRadius: 10,
                        backgroundColor: (selectedCategory && selectedCategory.name == 
                            item.name) ?  item.color : COLORS.white
                    }}
                    onPress={() => {
                    ...
                    <View style={{flex: 1, flexDirection: 'row', alignItems: 'center'}}>
                        <View
                            style={{
                                ...
                                height: 20,
                                backgroundColor: (selectedCategory && selectedCategory.name == 
                            item.name) ? COLORS.white : item.color,
                                borderRadius: 5,
                            }}
                        ></View>
                        <Text style={{ marginLeft: SIZES.base, color: (selectedCategory && selectedCategory.name == 
                            item.name) ? COLORS.white : COLORS.primary,
                             ...FONTS.h3 }}>{item.name}</Text>
                    </View>
                    {/* Expenses */}
                    <View style={{ justifyContent: 'center'}}>
                        <Text style={{ color: (selectedCategory && selectedCategory.name == 
                            item.name) ? COLORS.white : COLORS.primary , ...FONTS.h3 }}>{item.y} USD - {item.label}</Text>
                    </View>
                </TouchableOpacity>
            )
        }
